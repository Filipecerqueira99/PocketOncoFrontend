<template>
    <div>
        <div class="heyUser">Olá, {{ this.nameUser }}</div>
        <div class="topImg"><img class="iconImg" src="../assets/loginimg.png" alt="Dor" /></div>
    </div>
   ...
   <button class="buttonNext" @click.prevent="Login()">Seguinte</button>
</template>
